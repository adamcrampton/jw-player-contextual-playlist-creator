...
// Define settings
// ===============
const playlistNames = ['array', 'of','your', 'playlist', 'names'];
...
for (let i=0; i < playlistLength; i++) {
  ...
  let requestString = endpoint + '&title=' + playlistNames[i] + '&' + api_signature;
...
function makeApiSignature() {
  ...
  let hashString = 'api_format=xml&api_key=' + api_key + '&api_nonce=' + api_nonce + '&api_timestamp=' + Date.now() + '&text=playlistcreation' + api_secret;
